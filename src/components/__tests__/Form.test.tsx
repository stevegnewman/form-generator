...
describe('Form', () => {
  ...
  it('matches snapshot for initial render', () => {
    const { container } = render(<Form config={mockConfig} onSubmit={mockOnSubmit} />);
  ...
  it('warns about duplicate field names in config', () => {
      ...
      questions: [
        {
          ...
          fields: [{ name: 'duplicate_field', label: 'First Duplicate', type: 'text' }],
        },
        {
          title: 'Test Question 2',
          fields: [{ name: 'duplicate_field', label: 'Second Duplicate', type: 'text' }],
        },
      ],
    };
    ...
    expect(consoleSpy).toHaveBeenCalledWith(expect.stringContaining('duplicate_field'));
